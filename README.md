...
- **VLSM** (máscara variable): ingresa una IP base con prefijo y una lista de requerimientos de hosts; la calculadora ajusta cada requerimiento a la potencia de 2 superior, ordena de mayor a menor, valida el espacio y asigna subredes contiguas.
